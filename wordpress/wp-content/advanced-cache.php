...
$possible_plugin_locations = array(
	...
	'C:\MAMP\htdocs\Planty\wordpress\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/Planty/wordpress/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\MAMP\htdocs\Planty\wordpress\wp-content\plugins\wp-optimize\cache/extensions');
}
